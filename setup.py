...
def get_version_info():
    ...
    elif os.path.exists('sysid/version.py'):
        # must be a source distribution, use existing version file
        try:
            from sysid.version import git_revision as GIT_REVISION
        except ImportError:
            raise ImportError("Unable to import git_revision. Try removing "
                              "sysid/version.py and the build directory "
                              "before building.")
    else:
        GIT_REVISION = "Unknown"
...
def write_version_py(filename='sysid/version.py'):
    cnt = """
